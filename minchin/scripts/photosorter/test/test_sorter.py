...
def reset_mtimes():
    ...
    """
    set_mtime(
        str(EXAMPLE_DIR / '2004-05-07 20.16.31.jpg'),
        datetime(2004, 5, 7, 11, 16, 31))
    set_mtime(
        str(EXAMPLE_DIR / '2006-09-09 07.00.24.jpg'),
        datetime(2006, 9, 8, 22, 0, 24))
    set_mtime(
        str(EXAMPLE_DIR / '2006-09-09 07.00.24-alt.jpg'),
        datetime(2006, 9, 9, 7, 0, 24))
    set_mtime(
        str(EXAMPLE_DIR / '2014-02-06 09.15.17.jpg'),
...
class RenamerTests(unittest.TestCase):
    ...
    def test_folder_from_datetime(self):
        self.assertEquals(
            sorter.folder_from_datetime(datetime(2014, 2, 7)), '2014-02/2014_02_07')
