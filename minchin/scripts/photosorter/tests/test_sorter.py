...
EXAMPLE_DIR = HERE / "test_examples"
...
def reset_mtimes():
    ...
    """
    set_mtime(
        str(EXAMPLE_DIR / "2004-05-07 20.16.31.jpg"), datetime(2004, 5, 7, 11, 16, 31)
    )
    set_mtime(
        str(EXAMPLE_DIR / "2006-09-09 07.00.24.jpg"), datetime(2006, 9, 8, 22, 0, 24)
    )
    set_mtime(
        str(EXAMPLE_DIR / "2006-09-09 07.00.24-alt.jpg"), datetime(2006, 9, 9, 7, 0, 24)
    )
    set_mtime(
        str(EXAMPLE_DIR / "2014-02-06 09.15.17.jpg"), datetime(2014, 2, 6, 9, 15, 17)
    )
    set_mtime(str(EXAMPLE_DIR / "no-exif.jpg"), datetime(2014, 2, 23, 21, 47, 14))
    set_mtime(str(EXAMPLE_DIR / "test.png"), datetime(2014, 3, 8, 18, 31, 35))
...
class RenamerTests(unittest.TestCase):
    ...
    def test_folder_from_datetime(self):
        case = sorter.folder_from_datetime(datetime(2014, 2, 7))
        expected = "2014-02/2014_02_07"
    ...
    def test_path_from_datetime(self):
        ...
        expected = "2004-05/2004_05_07/2004-05-07 20.16.31.jpg"
    ...
    def test_path_from_datetime_2(self):
        case = sorter.path_from_datetime(
            "/home/user/Dropbox",
    ...
    def test_resolve_duplicate(self):
        ...
        expected = "test_examples/root/2006-09/2006_09_09/2006-09-09 07.00.24-2.jpg"
        self.assertEqual(case, expected)

        case = sorter.resolve_duplicate(
            "test_examples/root/2006/2006-09/2006-09-09 07.00.25.jpg"
        )
        expected = "test_examples/root/2006-09/2006_09_09/2006-09-09 07.00.25.jpg"
        self.assertEqual(case, expected)
    ...
    def test_move_file(self, move_mock, makedirs_mock):
        ...
        makedirs_mock.assert_called_with("/root/2006-09/2006_09_09")
        move_mock.assert_called_with(
            "test_examples/2006-09-09 07.00.24.jpg",
            "/root/2006-09/2006_09_09/2006-09-09 07.00.24.jpg",
        )
        ...
        makedirs_mock.assert_called_with("test_examples/root/2006-09/2006_09_09")
        move_mock.assert_called_with(
            "test_examples/2006-09-09 07.00.24-alt.jpg",
            "test_examples/root/2006-09/2006_09_09/2006-09-09 07.00.24-2.jpg",
        )

        # Ignore duplicates.
        makedirs_mock.reset_mock()
        move_mock.reset_mock()
        sorter.move_file("test_examples/root/", "test_examples/2006-09-09 07.00.24.jpg")
